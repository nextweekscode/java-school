...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleResourceNotFoundException(ResourceNotFoundException rnfe) {
        ...
        errorDetail.setDetail("Found an issue with School: " + rnfe.getMessage());
    ...
    public ResponseEntity<?> handleResourceFoundException(ResourceFoundException rfe) {
        ...
        errorDetail.setDetail("Found an issue with School: " + rfe.getMessage());
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex,
        ...
        errorDetail.setStatus(status.value());
        errorDetail.setTitle("Rest Internal Exception");
        errorDetail.setDetail("Found an issue with School: " + ex.getMessage()); //request.getDescription(false)
        errorDetail.setDevelopermessage(ex.getClass().getName());
        errorDetail.setErrors(helperFunctions.getConstraintViolations(ex));
